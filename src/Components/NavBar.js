  ...
  return (
    <div className="d-flex flex-column flex-md-row align-items-center p-3 pb-3 mb-4 border-bottom">
      ...
      <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">World</a>
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">Econom</a>
        <a className="me-3 py-2 text-dark text-decoration-none" href="#">Sport</a>
      </nav>
    </div>
  );
}